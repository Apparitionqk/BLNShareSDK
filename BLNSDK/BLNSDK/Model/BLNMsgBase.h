...
@property (nonatomic, strong) NSString *content; //!< 分享文字时表示内容，图片、视频、文件等类型时表示链接或文件路径，链接类型时表示链接URL
@property (nonatomic, assign) BLNShareType shareType; //!< 分享类型
@end


/**
 分享链接类型的消息时，需要使用此Model
 */
